...
import {
} from "./Bool_Expression_Generator.js";
import {generate_boolean_expression_as_string} from "./Bool_Expression_Generator.js";
...
let experiment_configuration_function = (writer: Experiment_Output_Writer) => { return {
    ...
    layout: [
        ...
        { variable: "TermsPerAnd",  treatments: ["1", "2", "3"]},
        { variable: "AnswerPosition",  treatments: ["1", "2", "3", "4", "5"]}
    ],
    ...
    task_configuration:    (t:Task) => {
        ...
        string_to_show = generate_boolean_expression_as_string(
                                                                  ...
                                                                  parseInt(t.treatment_value("TermsPerAnd")),
                                                                  parseInt(t.treatment_value("AnswerPosition"))
                                                              );



        t.expected_answer = t.treatment_value("AnswerPosition");
