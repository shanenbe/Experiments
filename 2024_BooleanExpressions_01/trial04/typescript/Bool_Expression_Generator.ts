...
import {repeat_, repeat_n_times} from "../../../N-of-1-Experimentation/modules/utils/loops/loop.js";
...
export function generate_boolean_expression_as_string(
                                                        treat_var_format:string,
                                                        terms_per_and: number,
                                                        answerPos: number
                                                     ):string {
    let number_of_lines = 5;
    let number_of_literals = terms_per_and * number_of_lines;
    let literals:string[] = [];
    ...
    repeat_(number_of_lines)._times( () => {
        and_snippets.push([]);
        repeat_(terms_per_and)._times( () =>{
